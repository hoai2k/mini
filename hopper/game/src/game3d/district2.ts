...
export function tempestDocks(): District {
  const placements: Placement[] = [
    ...
    P('structure.harbor.craneBoom', 0, -820, 0, Math.PI, { h: 100, reach: 90 }),
  ...
  const shadows: ShadowSpawn[] = [
    ...
    S('cy6', 'chainManta', 0, -820, { y: 140, mode: 'a', group: 'yard', entry: 'perch', delay: 3.5 }),
...
export function skyhookWorks(): District {
  const placements: Placement[] = [
    ...
    P('structure.launchworks.launchRing', 0, -1490, 0, 0, { r: 60, tube: 6, height: 120 }),
    pistons(-130, -1400, 0.6, 6, 12),
    pistons(130, -1420, -0.6, 6, 10),
    P('structure.launchworks.rocket', -140, -1560, 0, 0, { r: 9, h: 160 }),
    P('structure.launchworks.rocket', 150, -1580, 0, 0, { r: 9, h: 160 }),
    P('prop.thermalVent', 0, -1490, 0, 0, { height: 150 }),
    P('prop.recoveryCapsule', 0, -1420, 3),
    P('prop.signalBeacon', 0, -1430, 126, 0),
    P('prop.checkpointTotem', 0, -1720),
    ...
    P('structure.launchworks.pistonStair', -90, -1800, 0, 0.3, { count: 5 }),
    P('structure.launchworks.rocket', 110, -1840, 0, 0, { r: 9, h: 150 }),
    P('prop.thermalVent', 0, -1860, 0, 0, { height: 160 }),
    P('structure.launchworks.gantryElevator', 0, -2000, 0, 0, { h: 150, w: 16 }),
    P('structure.launchworks.rocket', -70, -2010, 0, 0, { r: 10, h: 170 }),
    P('structure.launchworks.launchRing', 0, -2000, 0, 0, { r: 70, tube: 5, height: 150 }),
    P('prop.thermalVent', 60, -1960, 0, 0, { height: 180 }),
    P('prop.recoveryCapsule', -40, -1900, 3),
    P('prop.signalBeacon', -70, -2010, 171, 0),
  ...
  const shadows: ShadowSpawn[] = [
    ...
    // Stronghold 2 host.
    S('r1', 'turbineWasp', 60, -1490, { y: 340, mode: 'a', group: 'ring', entry: 'perch', delay: 0 }),
    S('r2', 'turbineWasp', -60, -1490, { y: 340, mode: 'a', group: 'ring', entry: 'perch', delay: 1 }),
    S('r3', 'turbineWasp', 0, -1430, { y: 340, mode: 'a', group: 'ring', entry: 'perch', delay: 2 }),
    S('r4', 'turbineWasp', 0, -1550, { y: 340, mode: 'a', group: 'ring', entry: 'perch', delay: 3 }),
    S('r5', 'coilWraith', -40, -1490, { y: 130, group: 'ring', entry: 'perch', delay: 0.5, link: [40, 136, -1490] }),
    S('r6', 'coilWraith', 40, -1490, { y: 130, group: 'ring', entry: 'perch', delay: 0.5, link: [-40, 136, -1490] }),
    S('r7', 'turbineWasp', -30, -1470, { y: 300, mode: 'a', group: 'ring', entry: 'ambush', delay: 5 }),
    S('r8', 'turbineWasp', 40, -1520, { y: 350, mode: 'a', group: 'ring', wave: 1, entry: 'perch' }),
    S('r9', 'turbineWasp', -40, -1460, { y: 350, mode: 'a', group: 'ring', wave: 1, entry: 'perch' }),
    S('r10', 'turbineWasp', 0, -1500, { y: 350, mode: 'a', group: 'ring', wave: 1, entry: 'perch' }),
  ...
  return {
    ...
    terrain: {
      ...
      plateaus: [
        ...
        { x: 0, z: -1490, r: 260, y: 200 },
        { x: 0, z: -1900, r: 130, y: 260 },
        { x: 0, z: -2000, r: 300, y: 300 },
      ],
      valley: null,
    },
    horizon: { gap: { angle: Math.PI / 2, width: 0.5 } },
    ...
    chapters: [
      ...
      { name: 'The launch ring', z0: -1260, z1: -1720, beat: 'fight' },
      { name: 'The gantry elevator', z0: -1720, z1: -2400, beat: 'finish' },
    ],
    strongholds: [
      { id: 'pistons', name: 'The Piston Yard', x: 0, z: -680, r: 200, y: 30 },
      { id: 'ring', name: 'The Launch Ring', x: 0, z: -1490, r: 220, y: 60 },
    ],
    cages: [
      { id: 'cage-launchworks-1', x: 70, z: -420, y: 2, mode: 'r' },
      { id: 'cage-launchworks-2', x: -80, z: -1240, y: 2, mode: 'r' },
      { id: 'cage-launchworks-3', x: 90, z: -1920, y: 2, mode: 'r' },
    ],
    boss: { kind: 'smelterLeviathan', x: 0, z: -2000, y: 40, r: 260 },
    start: { x: 0, z: 20, yaw: Math.PI },
    exit: { x: 0, z: -2000, r: 40, name: 'The star gate' },
    landmark: { name: 'The star gate', x: 0, z: -2000 },
    route: windingRoute(placements, { x: 0, z: 20 }, { x: 0, z: -2000 }),
  };
}
