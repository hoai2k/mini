/** The Eclipse Regent: the mission-three commander at the eclipse dais. A placeholder that
...
export class EclipseRegent implements Commander {
  ...
  constructor(readonly spec: BossSpec, readonly world: World) {
    ...
    this.runtime = {
      kind: 'eclipseRegent', x: spec.x, y: ground + 12, z: spec.z, vx: 0, vy: 0, vz: 0, yaw: Math.PI, hp: REGENT.hp, maxHp: REGENT.hp, phase: 1, state: 'sleep', timer: 0, telegraph: 0, open: 0, hitFlash: 0, alive: true, active: false, radius: 8, height: 40, marks: [], gravity: 1, laserHits: new Set(), kickHit: false,
    };
  }
  target(): Shadow {
