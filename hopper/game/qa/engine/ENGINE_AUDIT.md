...
- Core combat tests verify all species attack, all bosses cycle/transition phases, victory callback occurs once, launches hit behind, stomps rebound, armored crowns reject stomps, attack IDs prevent multiple hits per swing, and inverted player collision is correctly placed.
...
Each mission retains 15 chapters, 135 route shelves, ~115–117k world pixels, 87 enemies (30 ambushes), 31 checkpoints, 9 optional fragments, 18 high roads and 18–23 catch floors. Raw maximum-speed movement is ~55–64 seconds per area; actual first-clear/campaign times are unmeasured and should not be presented as verified.
