...
- **Status:** delivered (awaiting-verification) · **Final:** `textures/surface/{sea,dust,slag}.png`
...
- **Status:** delivered (awaiting-verification) · **Final:** `textures/ui/landing-guide-light.png`
...
- **Status:** delivered (awaiting-verification) · **Final:** `textures/effects/hopper.png`
...
- **Status:** delivered (awaiting-verification) · **Final:** `textures/ui/props.png`
- **In the game:** guideVariant picks the ivory guide on dark floors; the prop decals sit on every totem lamp (lit/unlit), spring pad plate and cage crown.
