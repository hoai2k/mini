...
- **Status:** open · **Final:** `textures/surface/{sea,dust,slag}.png`
...
- **Status:** open · **Final:** `textures/ui/landing-guide-light.png`
...
- **Status:** open · **Final:** `textures/effects/hopper.png`
...
- **Status:** open · **Final:** `textures/ui/props.png`
