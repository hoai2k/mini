...
- **Status:** stand-in · **Stand-in:** `terrain.sky` · **Final:** `textures/sky/fields.ktx2`
...
- **Spec:** 8192×4096 equirectangular, painted, no lens effects; horizon at the vertical centre; sun or eclipse placed 100° right of +Z
- **Status:** stand-in · **Stand-in:** `terrain.sky` · **Final:** `textures/sky/city.ktx2`
...
- **Spec:** 8192×4096 equirectangular, painted, no lens effects; horizon at the vertical centre; sun or eclipse placed 100° right of +Z
- **Status:** stand-in · **Stand-in:** `terrain.sky` · **Final:** `textures/sky/mountains.ktx2`
...
- **Spec:** 8192×4096 equirectangular, painted, no lens effects; horizon at the vertical centre; sun or eclipse placed 100° right of +Z
- **Status:** stand-in · **Stand-in:** `terrain.sky` · **Final:** `textures/sky/foundry.ktx2`
...
- **Spec:** 8192×4096 equirectangular, painted, no lens effects; horizon at the vertical centre; sun or eclipse placed 100° right of +Z
- **Status:** stand-in · **Stand-in:** `terrain.sky` · **Final:** `textures/sky/harbor.ktx2`
...
- **Spec:** 8192×4096 equirectangular, painted, no lens effects; horizon at the vertical centre; sun or eclipse placed 100° right of +Z
- **Status:** stand-in · **Stand-in:** `terrain.sky` · **Final:** `textures/sky/launchworks.ktx2`
...
- **Spec:** 8192×4096 equirectangular, painted, no lens effects; horizon at the vertical centre; sun or eclipse placed 100° right of +Z
- **Status:** stand-in · **Stand-in:** `terrain.sky` · **Final:** `textures/sky/red.ktx2`
...
- **Spec:** 8192×4096 equirectangular, painted, no lens effects; horizon at the vertical centre; sun or eclipse placed 100° right of +Z
- **Status:** stand-in · **Stand-in:** `terrain.sky` · **Final:** `textures/sky/blue.ktx2`
...
- **Spec:** 8192×4096 equirectangular, painted, no lens effects; horizon at the vertical centre; sun or eclipse placed 100° right of +Z
- **Status:** stand-in · **Stand-in:** `terrain.sky` · **Final:** `textures/sky/violet.ktx2`
...
- **Status:** stand-in · **Stand-in:** `terrain.horizon` · **Final:** `textures/horizon/fields-<ring>-<n>.png`
...
- **Spec:** two rings of 8 cards, 4096×1024 each, alpha, painted silhouettes at two haze depths
- **Status:** stand-in · **Stand-in:** `terrain.horizon` · **Final:** `textures/horizon/city-<ring>-<n>.png`
...
- **Spec:** two rings of 8 cards, 4096×1024 each, alpha, painted silhouettes at two haze depths
- **Status:** stand-in · **Stand-in:** `terrain.horizon` · **Final:** `textures/horizon/mountains-<ring>-<n>.png`
...
- **Spec:** two rings of 8 cards, 4096×1024 each, alpha, painted silhouettes at two haze depths
- **Status:** stand-in · **Stand-in:** `terrain.horizon` · **Final:** `textures/horizon/foundry-<ring>-<n>.png`
...
- **Spec:** two rings of 8 cards, 4096×1024 each, alpha, painted silhouettes at two haze depths
- **Status:** stand-in · **Stand-in:** `terrain.horizon` · **Final:** `textures/horizon/harbor-<ring>-<n>.png`
...
- **Spec:** two rings of 8 cards, 4096×1024 each, alpha, painted silhouettes at two haze depths
- **Status:** stand-in · **Stand-in:** `terrain.horizon` · **Final:** `textures/horizon/launchworks-<ring>-<n>.png`
...
- **Spec:** two rings of 8 cards, 4096×1024 each, alpha, painted silhouettes at two haze depths
- **Status:** stand-in · **Stand-in:** `terrain.horizon` · **Final:** `textures/horizon/red-<ring>-<n>.png`
...
- **Spec:** two rings of 8 cards, 4096×1024 each, alpha, painted silhouettes at two haze depths
- **Status:** stand-in · **Stand-in:** `terrain.horizon` · **Final:** `textures/horizon/blue-<ring>-<n>.png`
...
- **Spec:** two rings of 8 cards, 4096×1024 each, alpha, painted silhouettes at two haze depths
- **Status:** stand-in · **Stand-in:** `terrain.horizon` · **Final:** `textures/horizon/violet-<ring>-<n>.png`
...
- **Status:** stand-in · **Stand-in:** `texture.grass` · **Final:** `textures/terrain/fields/`
...
- **Spec:** three 2048² tileable albedo textures (ground, cliff, path) + one 512² splat mask template
- **Status:** stand-in · **Stand-in:** `texture.ivory` · **Final:** `textures/terrain/city/`
...
- **Spec:** three 2048² tileable albedo textures (ground, cliff, path) + one 512² splat mask template
- **Status:** stand-in · **Stand-in:** `texture.rock` · **Final:** `textures/terrain/mountains/`
...
- **Spec:** three 2048² tileable albedo textures (ground, cliff, path) + one 512² splat mask template
- **Status:** stand-in · **Stand-in:** `texture.iron` · **Final:** `textures/terrain/foundry/`
...
- **Spec:** three 2048² tileable albedo textures (ground, cliff, path) + one 512² splat mask template
- **Status:** stand-in · **Stand-in:** `texture.wetSteel` · **Final:** `textures/terrain/harbor/`
...
- **Spec:** three 2048² tileable albedo textures (ground, cliff, path) + one 512² splat mask template
- **Status:** stand-in · **Stand-in:** `texture.rust` · **Final:** `textures/terrain/launchworks/`
...
- **Spec:** three 2048² tileable albedo textures (ground, cliff, path) + one 512² splat mask template
- **Status:** stand-in · **Stand-in:** `texture.coral` · **Final:** `textures/terrain/red/`
...
- **Spec:** three 2048² tileable albedo textures (ground, cliff, path) + one 512² splat mask template
- **Status:** stand-in · **Stand-in:** `texture.reef` · **Final:** `textures/terrain/blue/`
...
- **Spec:** three 2048² tileable albedo textures (ground, cliff, path) + one 512² splat mask template
- **Status:** stand-in · **Stand-in:** `texture.obsidian` · **Final:** `textures/terrain/violet/`
...
- **Status:** stand-in · **Stand-in:** `texture.grass` · **Final:** `textures/trim/fields.png`
...
- **Spec:** 4096² albedo trim sheet + 4096² emissive/mask, 8–12 horizontal strips
- **Status:** stand-in · **Stand-in:** `texture.ivory` · **Final:** `textures/trim/city.png`
...
- **Spec:** 4096² albedo trim sheet + 4096² emissive/mask, 8–12 horizontal strips
- **Status:** stand-in · **Stand-in:** `texture.rock` · **Final:** `textures/trim/mountains.png`
...
- **Spec:** 4096² albedo trim sheet + 4096² emissive/mask, 8–12 horizontal strips
- **Status:** stand-in · **Stand-in:** `texture.iron` · **Final:** `textures/trim/foundry.png`
...
- **Spec:** 4096² albedo trim sheet + 4096² emissive/mask, 8–12 horizontal strips
- **Status:** stand-in · **Stand-in:** `texture.wetSteel` · **Final:** `textures/trim/harbor.png`
...
- **Spec:** 4096² albedo trim sheet + 4096² emissive/mask, 8–12 horizontal strips
- **Status:** stand-in · **Stand-in:** `texture.rust` · **Final:** `textures/trim/launchworks.png`
...
- **Spec:** 4096² albedo trim sheet + 4096² emissive/mask, 8–12 horizontal strips
- **Status:** stand-in · **Stand-in:** `texture.coral` · **Final:** `textures/trim/red.png`
...
- **Spec:** 4096² albedo trim sheet + 4096² emissive/mask, 8–12 horizontal strips
- **Status:** stand-in · **Stand-in:** `texture.reef` · **Final:** `textures/trim/blue.png`
...
- **Spec:** 4096² albedo trim sheet + 4096² emissive/mask, 8–12 horizontal strips
- **Status:** stand-in · **Stand-in:** `texture.obsidian` · **Final:** `textures/trim/violet.png`
...
- **Status:** stand-in · **Stand-in:** `texture.shadow` · **Final:** `textures/creatures/shadow-hide.png`
...
- **Status:** open · **Stand-in:** `none` · **Final:** `textures/ui/landing-guide.png`
...
- **Status:** open · **Stand-in:** `none` · **Final:** `textures/ui/lock-on.png`
...
- **Status:** open · **Stand-in:** `none` · **Final:** `textures/ui/icons-3d.png`
...
- **Status:** open · **Stand-in:** `none` · **Final:** `textures/ui/signals.png`
...
- **Status:** open · **Stand-in:** `none` · **Final:** `textures/effects/`
...
- **Status:** open · **Stand-in:** `none` · **Final:** `textures/effects/gravity.png`
