...
Current disposition (2026-09-12): the later canonical art pass is root-reviewed
and integrated at `hopper/3d/models/enemies/chainManta.glb`. This file records the
historical scaffold; final art, QA, and reproduction details are in
`chain-manta-refine-progress.md` and `chain-manta-refine-validation.json`.
